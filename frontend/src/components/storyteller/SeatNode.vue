...
const role = computed(() => player.value?.role || props.seat.assigned_role || null)
...
<template>
  <button
    ...
    :class="[
      ...
      { 'is-empty': !player, 'is-dead': player && !player.alive, 'is-selected': selected, 'is-contextual': contextual },
    ]"
    type="button"
    :data-seat="seat.seat"
    :style="position"
