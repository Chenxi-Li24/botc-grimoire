...
BMR_ROLES = [
    ...
    {"id": "grandmother", "name": "祖母", "en": "Grandmother", "team": TOWNSFOLK,
     "ability": "首夜,你得知一名善良玩家及其角色;若他死于恶魔之手,你也死亡。"},
    ...
    {"id": "gambler", "name": "赌徒", "en": "Gambler", "team": TOWNSFOLK,
     "ability": "每夜选择一名玩家并猜测其角色:若猜错,你死亡。"},
    ...
    {"id": "lunatic", "name": "疯子", "en": "Lunatic", "team": OUTSIDER,
     "ability": "你以为自己是恶魔,但攻击目标由说书人决定,你得知的爪牙也可能是假的。"},
    ...
    {"id": "godfather", "name": "教父", "en": "Godfather", "team": MINION,
     "ability": "首夜你得知所有外来者是谁;每次白天首次有外来者被处决,当晚你杀死一名玩家。"},
...
SV_ROLES = [
    ...
    {"id": "dreamer", "name": "梦想家", "en": "Dreamer", "team": TOWNSFOLK,
     "ability": "每夜选择一名玩家:你得知他可能是哪两个角色之一。"},
    {"id": "snakecharmer", "name": "舞蛇人", "en": "Snake Charmer", "team": TOWNSFOLK,
     "ability": "每夜选择一名玩家:若他是恶魔,你成为恶魔,他变成善良的舞蛇人并中毒。"},
    ...
    {"id": "savant", "name": "学者", "en": "Savant", "team": TOWNSFOLK,
     "ability": "每天,说书人会告诉你两条信息,一条为真、一条为假。"},
    ...
    {"id": "philosopher", "name": "哲学家", "en": "Philosopher", "team": TOWNSFOLK,
     "ability": "每局一次,夜晚获得一个角色(可以不在本局中)的能力。"},
    ...
    # ---- 外来者 (4) ----
    {"id": "sweetheart", "name": "甜心", "en": "Sweetheart", "team": OUTSIDER,
     "ability": "你死亡时,一名玩家从此醉酒。"},
    ...
    {"id": "mutant", "name": "变种人", "en": "Mutant", "team": OUTSIDER,
     "ability": "你是外来者,但不能公开承认;若你公开声称自己是外来者,可能被处决。"},
    # ---- 爪牙 (4) ----
    {"id": "cerenovus", "name": "塞雷诺维斯", "en": "Cerenovus", "team": MINION,
     "ability": "每夜选择一名玩家与一个角色:次日,他必须宣称自己是那个角色,否则可能被处决。"},
    {"id": "pithag", "name": "巫婆", "en": "Pit-Hag", "team": MINION,
     "ability": "每夜可以将一名玩家变成任意角色;若该角色已在场,原持有者死亡。"},
    ...
    {"id": "fang-gu", "name": "方古", "en": "Fang Gu", "team": DEMON,
     "ability": "每夜选择一名玩家:他死亡。若你被处决,你转移到一名外来者身上,该外来者死亡(本局 +1 外来者)。"},
    {"id": "vigormortis", "name": "维格莫提斯", "en": "Vigormortis", "team": DEMON,
     "ability": "每夜选择一名玩家:他死亡。与你相邻的爪牙被处决后不会死,且保留能力。"},
